    ...
    <section className="max-w-3xl mx-auto px-4 py-5 pb-28">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={() => setMostrarFormCliente(true)}
          className="flex items-center gap-1.5 bg-emerald-600 text-white rounded-full px-4 py-2 text-sm font-semibold hover:bg-emerald-700 active:scale-95 transition">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handleCrearCliente}
                className="flex-1 bg-emerald-600 text-white rounded-xl py-2.5 font-semibold text-sm hover:bg-emerald-700 transition">
                Guardar
              </button>
            </div>
          </div>
                                        ...
                                        {pagando ? (
                                          <div className="flex gap-2 items-center">
                                            <input type="text" inputMode="decimal" value={valorPago}
                                              ...
                                              className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/40" />
                                            <button onClick={() => handlePago(f.id)}
                                              className="bg-emerald-600 text-white rounded-lg px-4 py-2 font-semibold text-sm hover:bg-emerald-700 transition">
                                              OK
                                            </button>
                                          ...
                                          <button onClick={() => setMostrarPago(f.id)}
                                            className="w-full bg-emerald-500 text-white rounded-xl py-2 font-bold text-xs hover:bg-emerald-600 active:scale-95 transition">
                                            Registrar pago
                                          </button>
                                        )}
                                      </div>
